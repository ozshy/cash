...
prp(pi_tree2, type = 3, box.palette = "auto", extra = 100, under = T, tweak = 1.0, varlen = 0, faclen = 0)#faclet=0 avoids abvreviations, tweak for char size
...
#
prp(pi_prune2, type = 3, box.palette = "auto", legend.x=NA, legend.y=NA, extra = 100, under = T, tweak = 3.1, under.cex = 1.5, varlen = 0, faclen = 0, Margin = 0.0, digits = 0)#faclet=0 avoids abvreviations, tweak for char size
