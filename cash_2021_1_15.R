...
#dir()
#atm1=read.csv("ATM_50_countries.csv")
#saveRDS(atm1, "ATM_50_countries.rds")    
atm2 = readRDS("ATM_50_countries.rds")
dim(atm2)
names(atm2)
names(atm2) = c("country", "code", "no_atm")
atm2
(atm3 = atm2)
str(atm3)
# shortening some countries' names
levels(atm3$country)
levels(atm3$country)[atm3$country=="Congo, Dem. Rep."] = "Congo"
levels(atm3$country)[atm3$country=="Egypt, Arab Rep."] = "Egypt"
levels(atm3$country)[atm3$country=="Iran, Islamic Rep."] = "Iran"
levels(atm3$country)[atm3$country=="Venezuela, RB"] = "Venezuela"
levels(atm3$country)[atm3$country=="Russian Federation"] = "Russia"
levels(atm3$country)[atm3$country=="Yemen, Rep."] = "Yemen"
#
ggplot(atm3, aes(x=no_atm, y=reorder(country, no_atm)))+
  geom_point(size=3)+
